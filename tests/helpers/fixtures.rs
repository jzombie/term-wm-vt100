...
impl FixtureCell {
    #[allow(dead_code)]
    pub fn from_cell(cell: &term_wm_vt100::Cell) -> Self {
        Self {
...
pub struct FixtureScreen {
    ...
    mouse_protocol_mode: term_wm_vt100::MouseProtocolMode,
    #[serde(
        default,
    ...
    mouse_protocol_encoding: term_wm_vt100::MouseProtocolEncoding,
}
...
impl FixtureScreen {
    ...
    #[allow(dead_code)]
    pub fn from_screen(screen: &term_wm_vt100::Screen) -> Self {
...
fn deserialize_color<'a, D>(
    deserializer: D,
) -> std::result::Result<term_wm_vt100::Color, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let val = <Option<String>>::deserialize(deserializer)?;
    match val {
        None => Ok(term_wm_vt100::Color::Default),
        Some(x) if x.starts_with('#') => {
            ...
            Ok(term_wm_vt100::Color::Rgb(r, g, b))
        }
        Some(x) => Ok(term_wm_vt100::Color::Idx(
...
fn deserialize_mouse_protocol_mode<'a, D>(
    deserializer: D,
) -> std::result::Result<term_wm_vt100::MouseProtocolMode, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let name = <String>::deserialize(deserializer)?;
    match name.as_ref() {
        "none" => Ok(term_wm_vt100::MouseProtocolMode::None),
        "press" => Ok(term_wm_vt100::MouseProtocolMode::Press),
        "press_release" => Ok(term_wm_vt100::MouseProtocolMode::PressRelease),
        "button_motion" => Ok(term_wm_vt100::MouseProtocolMode::ButtonMotion),
        "any_motion" => Ok(term_wm_vt100::MouseProtocolMode::AnyMotion),
        _ => unimplemented!(),
    }
}

fn serialize_mouse_protocol_mode<S>(
    mode: &term_wm_vt100::MouseProtocolMode,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    let s = match mode {
        term_wm_vt100::MouseProtocolMode::None => "none",
        term_wm_vt100::MouseProtocolMode::Press => "press",
        term_wm_vt100::MouseProtocolMode::PressRelease => "press_release",
        term_wm_vt100::MouseProtocolMode::ButtonMotion => "button_motion",
        term_wm_vt100::MouseProtocolMode::AnyMotion => "any_motion",
    };
    serializer.serialize_str(s)
}
...
fn deserialize_mouse_protocol_encoding<'a, D>(
    deserializer: D,
) -> std::result::Result<term_wm_vt100::MouseProtocolEncoding, D::Error>
where
    D: serde::de::Deserializer<'a>,
{
    let name = <String>::deserialize(deserializer)?;
    match name.as_ref() {
        "default" => Ok(term_wm_vt100::MouseProtocolEncoding::Default),
        "utf8" => Ok(term_wm_vt100::MouseProtocolEncoding::Utf8),
        "sgr" => Ok(term_wm_vt100::MouseProtocolEncoding::Sgr),
        _ => unimplemented!(),
    }
}

fn serialize_mouse_protocol_encoding<S>(
    encoding: &term_wm_vt100::MouseProtocolEncoding,
    serializer: S,
) -> Result<S::Ok, S::Error>
where
    S: serde::Serializer,
{
    let s = match encoding {
        term_wm_vt100::MouseProtocolEncoding::Default => "default",
        term_wm_vt100::MouseProtocolEncoding::Utf8 => "utf8",
        term_wm_vt100::MouseProtocolEncoding::Sgr => "sgr",
    };
    serializer.serialize_str(s)
}
